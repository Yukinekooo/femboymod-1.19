...
public enum ModArmorMaterials implements ArmorMaterial {
    ASTOLFIUM("astolfium", 28, new int[]{2, 5, 8, 3}, 19, SoundEvents.ARMOR_EQUIP_LEATHER,
            2.0F, 0.0F, () -> Ingredient.of(ModItems.ASTOLFIUM.get()));
    ...
    public String getName() {
        return FemboyMod.MOD_ID + ":" + this.name;
    }
